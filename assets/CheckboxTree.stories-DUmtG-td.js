import{R as s,r as de}from"./index-RYns6xqu.js";/* empty css              */import{c as ce}from"./index-Cm1LdsEh.js";import{C as be}from"./Checkbox-D7lBUOGb.js";import{F as ge}from"./FieldWrapper-DTvEllJF.js";import"./useFocusByTab-DuF17kQm.js";import"./InputStatusIcon-COYgDJ0E.js";import"./index.esm-Dk8PHLvH.js";const w=e=>{const{items:r,onClickItem:t,small:n=!1,label:a="",readOnly:o=!1,disabled:m=!1}=e;return s.createElement(s.Fragment,null,s.createElement("span",{className:"checkbox-list-label"},a),s.createElement("ul",{className:ce("checkbox-list",{small:n})},r.map(u=>{const{id:p,props:l,items:d}=u;return s.createElement("li",{key:p},s.createElement(be,{small:n,onClick:q=>t(q,u),checked:u.props.checked,isIndeterminate:u.props.isIndeterminate,...l,disabled:m,readOnly:o}),d&&s.createElement(w,{...e,items:d}))})))};w.__docgenInfo={description:"",methods:[],displayName:"CheckboxList",props:{items:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  id: number;
  props: CheckboxProps;
  ...
  hint?: string;
  isIndeterminate?: boolean;
}`,signature:{properties:[{key:"label",value:{name:"string",required:!0}},{key:"small",value:{name:"boolean",required:!1}},{key:"hint",value:{name:"string",required:!1}},{key:"isIndeterminate",value:{name:"boolean",required:!1}}]}}],required:!0}},{key:"items",value:{name:"Array",elements:[{name:"CheckboxTreeItem"}],raw:"CheckboxTreeItem[]",required:!1}}]}}],raw:"CheckboxTreeItem[]"}}},description:""}}};const Ee=e=>{const[r,t]=de.useState(e.items),n=a=>t(a);return s.createElement(H,{...e,items:r,onChange:n})},xe={component:H,title:"Core/CheckboxesTree",tags:["autodocs"],argTypes:{disabled:{control:"boolean"},small:{control:"boolean"},readOnly:{control:"boolean"},required:{control:"boolean"}},render:e=>s.createElement(Ee,{...e})},me=[{id:1,props:{label:"Milk"}},{id:2,props:{label:"Butter"}},{id:3,props:{label:"Cream"}}],M=[{id:1,props:{label:"Milk"}},{id:2,props:{label:"Sugar"}},{id:3,props:{label:"Lemon slice"}}],b={args:{items:me}},g={args:{items:M,label:"With your tea"}},I={args:{items:M,label:"With your tea",hint:"At no extra cost for you"}},y={args:{items:[{id:1,props:{label:"A walk on the beach"}},{id:2,props:{label:"A bike ride on long forest winding roads"}},{id:3,props:{label:"Reading a book in a couch"}}]}},k={args:{items:[{id:0,props:{label:"Dairy products"},items:[{id:1,props:{label:"Milk"}},{id:2,props:{label:"Butter"}},{id:3,props:{label:"Cream"}}]}]}},h={args:{items:[{id:1,props:{label:"foo"},items:[{id:2,props:{label:"foo2"},items:[{id:3,props:{label:"foo3"}},{id:4,props:{label:"foo4"}}]},{id:5,props:{label:"foo5"},items:[{id:6,props:{label:"foo6"},items:[{id:8,props:{label:"foo8"}},{id:9,props:{label:"foo9"}}]}]}]},{id:7,props:{label:"foo7"}}]}},T={args:{items:M,label:"With your beverage",required:!0}},E={args:{items:me.map((e,r)=>r===1?{...e,props:{...e.props,checked:!0}}:{...e}),disabled:!0,statusWithMessage:{status:"info",message:"These controls are disabled"}},decorators:[e=>s.createElement("div",{style:{maxWidth:"20rem"}},s.createElement(e,null))]},f={args:{items:M,statusWithMessage:{status:"warning",message:"Your tea will be black, strong and not sweet at all"}},decorators:[e=>s.createElement("div",{style:{maxWidth:"20rem"}},s.createElement(e,null))]},C={args:{items:[{id:1,props:{label:"Chocolate cake"}},{id:2,props:{label:"Ice cream"}},{id:3,props:{label:"Tiramisu"}}],statusWithMessage:{status:"error",message:"You can’t order a meal without a pastry"}},decorators:[e=>s.createElement("div",{style:{maxWidth:"20rem"}},s.createElement(e,null))]};var A,N,S;b.parameters={...b.parameters,docs:{...(A=b.parameters)==null?void 0:A.docs,source:{originalSource:`{
  args: {
...
}`,...(Z=(X=T.parameters)==null?void 0:X.docs)==null?void 0:Z.source}}};var V,$,ee;E.parameters={...E.parameters,docs:{...(V=E.parameters)==null?void 0:V.docs,source:{originalSource:`{
  args: {
...
}`,...(ee=($=E.parameters)==null?void 0:$.docs)==null?void 0:ee.source}}};var ne,re,te;f.parameters={...f.parameters,docs:{...(ne=f.parameters)==null?void 0:ne.docs,source:{originalSource:`{
  args: {
    items: milkSugarLemon,
    statusWithMessage: {
      status: 'warning',
...
}`,...(te=(re=f.parameters)==null?void 0:re.docs)==null?void 0:te.source}}};var ae,se,oe;C.parameters={...C.parameters,docs:{...(ae=C.parameters)==null?void 0:ae.docs,source:{originalSource:`{
  args: {
    items: [{
      id: 1,
      props: {
...
}`,...(oe=(se=C.parameters)==null?void 0:se.docs)==null?void 0:oe.source}}};const Ae=["Default","GroupWithLabel","GroupWithLabelCaption","LabelOverflow","Nested","MoreNested","Required","Information","Warning","Error"];export{b as Default,C as Error,g as GroupWithLabel,I as GroupWithLabelCaption,E as Information,y as LabelOverflow,h as MoreNested,k as Nested,T as Required,f as Warning,Ae as __namedExportsOrder,xe as default};
